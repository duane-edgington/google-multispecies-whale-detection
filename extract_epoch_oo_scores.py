...
def process_json_directory(input_directory, output_file=None):
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = ['epoch_seconds', 'Oo_class_score']
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Extract epoch seconds and Oo class scores from JSON files. Oo score is extracted from the score list at the position where class_names contains "Oo".',
