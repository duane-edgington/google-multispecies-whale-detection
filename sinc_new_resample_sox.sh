...
days=$(seq 13 13) # just the 13th day of the month for this special run
audio_base_dir="/mnt/PAM_Archive"

decimated_base_dir="/mnt/PAM_Analysis/GoogleMultiSpeciesWhaleModel2/resampled_24kHz_sinc_5kHz" # sinc 10-5000
...
for day in ${days}; do
  ...
  for infile in "${prefix}"_*.wav; do
    ...
    sox "${infile}" -b 16 "${outfile}" rate -v 24000 sinc -n 32767 5-5000 highpass 10 fade 0.1 -0 0.1 vol 3 &
  done
