...
def create_plots(analysis_data, num_bins, output_file, time_period):
    ...
    column_info = f"Columns: {epoch_col} (epoch time), {score_col} (detection score) | Pattern: {name_pattern} | Time period: {period_name}"
...
def main():
    ...
    create_plots(analysis_data, args.bins, args.output, args.time_period)
